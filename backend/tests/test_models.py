"""Test models for database service tests.

This module provides SQLite-compatible versions of the models for testing.
"""
...
class Transcript(Base):
    ...
    ticket_id = Column(String(36), ForeignKey("tickets.id"), nullable=False, index=True)
    content = Column(Text, nullable=False)
    formatted_content = Column(Text)  # Using Text instead of JSON for SQLite
...
class Staff(Base):
    ...
    permissions = Column(Text, default="{}")  # Using Text instead of JSON for SQLite
